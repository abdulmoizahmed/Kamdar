...
import com.example.moizahmed.test1.Model.ModelSurveyReport;
...
public class SurveyReport extends AppCompatActivity {
    ...
    public void getReport(){
        ...
        ModelSurveyReport modelSurveyReport = new ModelSurveyReport();
        Cursor c1 = modelSurveyReport.getLandNumb(getApplicationContext());
        ...
        //Cursor c2 = modelSurveyReport.getSurveyReport(getApplicationContext(),);
         ...
         //Toast.makeText(SurveyReport.this, "Hello Umair :) " + landrec, Toast.LENGTH_SHORT).show();
        ...
        StringBuilder col5 = new StringBuilder("سروے نمبر");
        StringBuilder col4 = new StringBuilder("کمپنی");
        StringBuilder col3 = new StringBuilder("خرچ");
        StringBuilder col2 = new StringBuilder("پی ایچ");
        ...
        while(c1.moveToNext()) {
            ...
            String c = c1.getString(c1.getColumnIndex("landNumber"));
            r2col6.append(c+"\n");




            Cursor c2 = modelSurveyReport.getSurveyReport(getApplicationContext(), c);
            int records = c2.getCount();
            //Toast.makeText(SurveyReport.this, "surveys: in " +c+ " are " + records, Toast.LENGTH_SHORT).show();
        ...
        c2.moveToFirst();
            if(records >0) {
                ...
                do {
                    ...
                    String d = c2.getString(2);
                    String e = c2.getString(3);
                    String f = c2.getString(4);
