 ...
 */
public class ViewKhad extends Activity {
    Dialog listDialog;
    ListView mListView;
    String  itemValue;
    String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khad_malomat);
    ...
    private void SelectDialog() {
        ...
        mListView.setAdapter(adapter.getFertilizerArrayList());
    ...
    private void gettingValues() {
        ...
        Cursor cursor = modelKhad.getKhadDetail(getApplicationContext(),itemValue);
        cursor.moveToFirst();
