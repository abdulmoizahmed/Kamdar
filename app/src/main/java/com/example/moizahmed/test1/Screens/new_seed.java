 ...
 */
public class new_seed extends Activity implements DatePickerDialog.OnDateSetListener{
    ...
    private void initUI() {
        ...
        number= (FloatLabel) findViewById(R.id.seedID);
         owner= (FloatLabel) findViewById(R.id.editText31);
         dimension= (FloatLabel) findViewById(R.id.editText32);
         place= (FloatLabel) findViewById(R.id.editText33);
         expense1= (FloatLabel) findViewById(R.id.editText34);
        date1 = (TextView)findViewById(R.id.txt_date);
         v5= (TextView) findViewById(R.id.editText35);
    ...
    private void validateInputs() {
        Cursor cursor =  dbObject.retrieveSeedID(va.getText().toString());
